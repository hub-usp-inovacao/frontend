          ...
          <v-list-item-group>
            <v-list-item three-line v-for="(item, index) in filtered" :key="index">
              <v-list-item-content :class="contentMarginStyle">
                <v-list-item-title class="font-weight-bold item-title">{{ item.name }}</v-list-item-title>
                <v-list-item-subtitle class="hidden-sm-and-down">{{ item.description }}</v-list-item-subtitle>
              </v-list-item-content>
              <v-list-item-action>
