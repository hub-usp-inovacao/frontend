...
export class Skill {
  ...
  constructor(
    ...
    this.email = email;
    this.unities = unities.split(descRgxSplitter)
    ...
    const groupsInitials = groupInitials
      .replace(NDrgx, "")
    ...
    this.inspect.groupNames = groupNames
      .replace(NDrgx, "")
      .split(descRgxSplitter)
      .map((el) => removeAccent(el));
...
export class SkillGenerator {
  static run(row) {
    ...
    if (base.name.includes("Martin Gr")) {
      console.log("As unidades do cara aqui: ", base.unities);
    }
